 ...
 * the src/mongo/client/sdam/json_tests/sdam_tests sub-directory.
 *
 ...
 *  sdam_json_test --source-dir src/mongo/client/sdam/json_tests/sdam_tests
 *
 * Example invocation to run a single test:
 *  sdam_json_test --source-dir src/mongo/client/sdam/json_tests/sdam_tests --filter
 * normalize_uri_case
 */
